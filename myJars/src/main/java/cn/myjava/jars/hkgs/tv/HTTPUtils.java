...
public class HTTPUtils {
    ...
    public static HttpURLConnection createConnection(String url,
            String method, Map<String, String> headerParameters, String body, String cookie)
            throws Exception {
        URL Url = new URL(url);
    ...
    public static String post(String address,
            Map<String, String> headerParameters, String body, String cookie) throws Exception {

        return proxyHttpRequest(address, "POST", null,
                getRequestBody(headerParameters),cookie);
    }
    ...
    public static String get(String address,
        ...
        return proxyHttpRequest(address + "?"
                + getRequestBody(headerParameters), "GET", null, null ,cookie);
    }
    ...
    public static String getFile(String address,
            Map<String, String> headerParameters, File file, String cookie) throws Exception {
        String result = "fail";
    ...
    public static byte[] getFileByte(String address,
            Map<String, String> headerParameters, String cookie) throws Exception {
        byte[] result = null;

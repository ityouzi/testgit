package cn.myjava.jars.option.email;
...
public class EmailUtils
{
   ...
   private static String userName = "foreover_2014@163.com";
   //163邮箱客户端密码非163邮箱登录密码，为授权客户端密码
   private static String password = "girliess2017";
//   private String to = "174493573@qq.com";

   /**
    * 发送文本邮件
    * @throws Exception
    */
   public static boolean sendTextMail(String to)
   {
	   try{
    ...
    * @throws Exception
    */
   public static boolean sendHtmlMail(String to)
   {
	   try{
	      Properties pro = System.getProperties();
	      pro.put("mail.smtp.host", host);
    ...
    * @throws Exception
    */
   public static boolean sendImageMail(String to) 
   {
	   try{
	      Properties pro = System.getProperties();
	      pro.put("mail.smtp.host", host);
    ...
    * @throws Exception
    */
   public static boolean sendAttachmentMail(String to)
   {
	   try{
	      Properties pro = System.getProperties();
	      pro.put("mail.smtp.host", host);
    ...
    * @throws Exception
    */
   public static boolean sendImageAndAttachmentMail(String to) 
   {
	   try{
	      Properties pro = System.getProperties();
	      pro.put("mail.smtp.host", host);

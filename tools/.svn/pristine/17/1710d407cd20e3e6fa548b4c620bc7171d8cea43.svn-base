...
import cn.tools.imgscan.OcrUtils;

@SuppressWarnings("deprecation")
public class HlzhScan {
	
	public static void main(String[] args) throws IOException, TesseractException {
		EntityFull ef = new EntityFull();
		ef.setHbh("MU5713");
		ef.setDate("2018-05-10");
		ef = getFull(ef);
	...
	public static EntityFull getFull(EntityFull ef) throws ClientProtocolException, IOException{
		...
		ef.setHbinfo(hbinfo);
		List<EntityMx1> listMx1 = new ArrayList<EntityMx1>();
		List<EntityMx2> listMx2 = new ArrayList<EntityMx2>();
		
		Elements uls = et.getElementsByTag("ul");
		for(Element ul : uls){
			Elements lis = ul.getElementsByTag("li");
			EntityMx1 mx1 = new EntityMx1();

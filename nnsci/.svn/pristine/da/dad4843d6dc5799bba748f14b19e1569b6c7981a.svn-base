	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		...
		<div id="loginbox">
			<form action="" method="post" name="loginForm" id="loginForm">
				...
				<input name="DATAROLE" type="hidden" value="个人用户" id="DATAROLE"/>
	...
	function register(){
		if(rcheck()){
			...
			$.ajax({
		    	...
		    	data: {DATAROLE:$("#DATAROLE").val(),USERNAME:$("#USERNAME").val(),PASSWORD:$("#PASSWORD").val(),NAME:$("#name").val(),EMAIL:$("#EMAIL").val(),rcode:$("#rcode").val(),FKEY:$.md5('USERNAME'+nowtime+',fh,'),tm:new Date().getTime()},
				dataType:'json',
				cache: false,
				success: function(data){
					if("00" == data.result){

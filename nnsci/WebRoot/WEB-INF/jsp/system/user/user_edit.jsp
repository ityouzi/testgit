						...
						<div class="col-xs-12">
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">数据权限:</td>
											<td><select class="chosen-select form-control" name="DATAROLE" id="DATAROLE" data-placeholder="请选择数据权限" style="vertical-align:top;" style="width:98%;" >
												<option value="个人用户" <c:if test="${pd.DATAROLE == '个人用户'}">selected</c:if>>个人用户</option>
												<option value="管理员" <c:if test="${pd.DATAROLE == '管理员'}">selected</c:if>>管理员</option>
											</select></td>
										</tr>

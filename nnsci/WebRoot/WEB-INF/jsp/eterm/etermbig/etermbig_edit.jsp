 ...
 --%>							
						...
						--%>
							...
							<tr>
								...
								<td><input type="text" name="POST" id="POST" value="${pd.POST}" onkeyup="value=value.replace(/[^\d]/g,'').slice(0,5)" maxlength="255" placeholder="这里输入端口" title="端口" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">期限:</td>
								<td><input type="text"  name="TIMELIMIT" id="TIMELIMIT" value="${pd.TIMELIMIT}" onkeyup="value=value.replace(/[^\d]/g,'').slice(0,4)"  maxlength="255" placeholder="这里输入期限" title="期限" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">金额:</td>
								<td><input type="text" name="MONEY" id="MONEY" value="${pd.MONEY}" onkeyup="clearNoNum(this)" maxlength="255" placeholder="这里输入金额" title="金额" style="width:98%;"/></td>
							</tr>
							<tr>

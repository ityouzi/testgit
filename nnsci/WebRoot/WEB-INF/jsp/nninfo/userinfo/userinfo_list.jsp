						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="ROLE_TYPE" id="ROLE_TYPE" data-placeholder="角色类型请选择" style="vertical-align:top;width: 180px;">
									<option value=""></option>
								...
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="STATUS" id="STATUS" data-placeholder="状态请选择" style="vertical-align:top;width: 180px;">
									<option value=""></option>
								...
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="SEX" id="SEX" data-placeholder="性别请选择" style="vertical-align:top;width: 120px;">
									<option value=""></option>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.PAPERS}</td>
											<td class='center'>${var.PHONE}</td>
											<td class='center'>${var.MOBIL}</td>
											<td class='center'>${var.ADRESS}</td>
											<td class='center'>${var.EMAIL}</td>
											<td class='center'>${var.QQ}</td>
											<td class='center'>${var.WECHAT}</td>
											<td class='center'>${var.ZFB}</td>

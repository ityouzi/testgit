...
public class Zidian {
    ...
    public void setBushou(String bushou) {
        this.bushou = bushou == null ? null : bushou.trim();
    }
    ...
    public Integer getChubihua() {
        return chubihua;
    }

    public void setChubihua(Integer chubihua) {
        this.chubihua = chubihua;
    }

...
public class User {
    ...
    private String status;				//是否单身
    
    private String cw;					//称谓
    
	private String yl1;					//宗族标识

    private String yl2;					//生日

    private String yl3;					//是否在世

    private String yl4;					//忌日

    private String yl5;					//创建人
    
    private String yl6;					//创建时间

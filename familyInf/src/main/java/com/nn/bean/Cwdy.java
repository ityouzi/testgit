...
public class Cwdy {
    private String cwdyid;

    private String cwdy1;

    private String cwdy2;
    ...
    public String getCwdyid() {
        return cwdyid;
    }

    public void setCwdyid(String cwdyid) {
        this.cwdyid = cwdyid == null ? null : cwdyid.trim();
    }

    public String getCwdy1() {
        return cwdy1;
    }

    public void setCwdy1(String cwdy1) {
        this.cwdy1 = cwdy1 == null ? null : cwdy1.trim();
    }

    public String getCwdy2() {
        return cwdy2;
    }

    public void setCwdy2(String cwdy2) {
        this.cwdy2 = cwdy2 == null ? null : cwdy2.trim();
    }

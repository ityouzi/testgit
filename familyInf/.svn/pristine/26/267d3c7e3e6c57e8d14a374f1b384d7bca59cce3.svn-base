...
public class Chengwei {
    ...
    public Integer getChengweiId() {
        return chengweiId;
    }

    public void setChengweiId(Integer chengweiId) {
        this.chengweiId = chengweiId;
    }
    ...
    public void setChengwei(String chengwei) {
        this.chengwei = chengwei == null ? null : chengwei.trim();
    }

    public String getChengweidec() {
        return chengweidec;
    }

    public void setChengweidec(String chengweidec) {
        this.chengweidec = chengweidec == null ? null : chengweidec.trim();
    }
